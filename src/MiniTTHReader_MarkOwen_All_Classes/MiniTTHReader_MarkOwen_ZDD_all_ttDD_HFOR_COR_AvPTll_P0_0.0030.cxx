...
// #############################################################################
   ...
   // ttbar Scale Factors Applied
      ...
      #include "P0_0.0030/PtScale_Powheg_ttData_AvPTll_fitLINE_OS_DD_ttee__Init_Built_Code.C"   // Pt Scale Factors
  ...
  if (isData) {
    ...
    if  ( ( channelNumber >= 164440 && channelNumber <= 164443 )  ||
	  ...
	  // ttbar Pt scale factors (Powheg/Alpgen)
	      #include "P0_0.0030/PtScale_Powheg_ttData_AvPTll_fitLINE_OS_DD_ttee__Fill_Built_Code.C"
	      #include "P0_0.0030/PtScale_Powheg_ttData_AvPTll_fitLINE_OS_DD_ttem__Fill_Built_Code.C"
	      #include "P0_0.0030/PtScale_Powheg_ttData_AvPTll_fitLINE_OS_DD_ttmm__Fill_Built_Code.C"
    }
