...
// Sat May 18 18:46:46 2013 by ROOT version 5.28/00
// from TTree mini/4-vectors + variables required for scaling factors
// found on file: /Volumes/DATA/ttH-NewMiniNtuples_TRCR-14-00-03/MC12/user.jahreda.mc12_8TeV.164440.AlpgenJimmy_AUET2CTEQ6L1_ttbarlnlnNp0_baseline.MiniML.Apr.11.13.v4.130411063741.merge/user.jahreda.027411._00009.merge.ML_7F.root
//////////////////////////////////////////////////////////

#ifndef Mini_MarkOwen_TRCR14_00_03_h
#define Mini_MarkOwen_TRCR14_00_03_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class Mini_MarkOwen_TRCR14_00_03 {
public :
   ...
   UShort_t        lep_trigMatched[2];   //[lep_n]
   ...
   Float_t         lep_trackd0pvunbiased[2];   //[lep_n]
   Float_t         lep_tracksigd0pvunbiased[2];   //[lep_n]
   ...
   UInt_t          bjet_n;
   UInt_t          alljet_n;
   Float_t         jet_pt[6];   //[alljet_n]
   Float_t         jet_eta[6];   //[alljet_n]
   Float_t         jet_phi[6];   //[alljet_n]
   Float_t         jet_E[6];   //[alljet_n]
   Float_t         jet_m[6];   //[alljet_n]
   Float_t         jet_jvf[6];   //[alljet_n]
   Int_t           jet_trueflav[6];   //[alljet_n]
   Int_t           jet_truthMatched[6];   //[alljet_n]
   Float_t         jet_SV0[6];   //[alljet_n]
   Float_t         jet_MV1[6];   //[alljet_n]
   UInt_t          jet_flag[6];   //[alljet_n]
   Int_t           ttHDiLepBlind;
   ...
   Mini_MarkOwen_TRCR14_00_03(TTree *tree=0);
   virtual ~Mini_MarkOwen_TRCR14_00_03();
...
#ifdef Mini_MarkOwen_TRCR14_00_03_cxx
Mini_MarkOwen_TRCR14_00_03::Mini_MarkOwen_TRCR14_00_03(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Volumes/DATA/ttH-NewMiniNtuples_TRCR-14-00-03/MC12/user.jahreda.mc12_8TeV.164440.AlpgenJimmy_AUET2CTEQ6L1_ttbarlnlnNp0_baseline.MiniML.Apr.11.13.v4.130411063741.merge/user.jahreda.027411._00009.merge.ML_7F.root");
      if (!f) {
         f = new TFile("/Volumes/DATA/ttH-NewMiniNtuples_TRCR-14-00-03/MC12/user.jahreda.mc12_8TeV.164440.AlpgenJimmy_AUET2CTEQ6L1_ttbarlnlnNp0_baseline.MiniML.Apr.11.13.v4.130411063741.merge/user.jahreda.027411._00009.merge.ML_7F.root");
      }
...
Mini_MarkOwen_TRCR14_00_03::~Mini_MarkOwen_TRCR14_00_03()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Mini_MarkOwen_TRCR14_00_03::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Mini_MarkOwen_TRCR14_00_03::LoadTree(Long64_t entry)
{
...
void Mini_MarkOwen_TRCR14_00_03::Init(TTree *tree)
{
...
Bool_t Mini_MarkOwen_TRCR14_00_03::Notify()
{
...
void Mini_MarkOwen_TRCR14_00_03::Show(Long64_t entry)
{
...
Int_t Mini_MarkOwen_TRCR14_00_03::Cut(Long64_t entry)
{
...
#endif // #ifdef Mini_MarkOwen_TRCR14_00_03_cxx
