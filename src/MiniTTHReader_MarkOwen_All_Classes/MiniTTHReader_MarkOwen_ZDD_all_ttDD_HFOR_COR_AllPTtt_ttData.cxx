...
// #############################################################################
   ...
   // ttbar Scale Factors Applied
      ...
      #include "PtScale_ttData_AllPTtt_fitLINE_OS_DD_ttee__Init_Built_Code.C"            // Pt Scale Factors
  ...
  if (isData) {
    ...
    if  ( ( channelNumber >= 164440 && channelNumber <= 164443 )  ||
	  ...
	  // ttbar Pt scale factors (Data/Alpgen)
	      #include "PtScale_ttData_AllPTtt_fitLINE_OS_DD_ttee__Fill_Built_Code.C"
	      #include "PtScale_ttData_AllPTtt_fitLINE_OS_DD_ttem__Fill_Built_Code.C"
	      #include "PtScale_ttData_AllPTtt_fitLINE_OS_DD_ttmm__Fill_Built_Code.C"
    }
