...
// #############################################################################
   ...
   // ========================================
   // #include "HforScale_FDS_3dist_OS_DD_Zee__Init_Built_Code.C"	// Scale Factors for |ll.M()-91|< 10GeV
   // #include "HforScale_FDS8GeV_3dist_OS_DD_Zee__Init_Built_Code.C"	// Scale Factors for |ll.M()-91|<  8GeV
      #include "HforScale_FDS12GeV_3dist_OS_DD_Zee__Init_Built_Code.C"	// Scale Factors for |ll.M()-91|< 12GeV
  ...
  if (isData) {
    ...
    if  ( ( channelNumber >= 107650 && channelNumber <= 107655 )  ||
	  ...
	  ( channelNumber >= 126414 && channelNumber <= 126421 )  ){
          // #include "HforScale_FDS_3dist_OS_DD_Zee__Fill_Built_Code.C"	// Scale Factors for |ll.M()-91|< 10GeV
          // #include "HforScale_FDS_3dist_OS_DD_Zmm__Fill_Built_Code.C" 	// Scale Factors for |ll.M()-91|< 10GeV
	  //
          // #include "HforScale_FDS8GeV_3dist_OS_DD_Zee__Fill_Built_Code.C"	// Scale Factors for |ll.M()-91|<  8GeV
          // #include "HforScale_FDS8GeV_3dist_OS_DD_Zmm__Fill_Built_Code.C" 	// Scale Factors for |ll.M()-91|<  8GeV
	  //
          #include "HforScale_FDS12GeV_3dist_OS_DD_Zee__Fill_Built_Code.C"	// Scale Factors for |ll.M()-91|< 12GeV
          #include "HforScale_FDS12GeV_3dist_OS_DD_Zmm__Fill_Built_Code.C" 	// Scale Factors for |ll.M()-91|< 12GeV
    }
  }
  return myWeight;
