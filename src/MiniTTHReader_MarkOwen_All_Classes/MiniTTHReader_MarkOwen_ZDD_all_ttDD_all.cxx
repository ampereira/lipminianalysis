...
// #############################################################################
   ...
   // Z Scale Factors Applied
      #include "HforScale_FDS8GeV_3dist_OS_DD_Zee__Init_Built_Code.C"   			// Mass Scale Factors for |ll.M()-91|< 8GeV	
      #include "PtScale_FDS8GeV_3dist_Zdata_fitLINE_OS_CONTROL_DD_Zee__Init_Built_Code.C"   	// pT   Scale Factors for |ll.M()-91|< 8GeV	
   // ttbar Scale Factors Applied
      #include "HforScale_OS_ttDD_ee__Init_Built_Code.C"   					// Rate Scale Factors (Powheg/Alpgen)	
      //#include "PtScale_Powheg_ttData_AllPTtt_fitLINE_OS_DD_ttee__Init_Built_Code.C"   	// 1st Order pT   Scale Factors (Powheg/Alpgen)  
        #include "PtScale_Powheg_ttData_AllPTtt_fit2ndLINE_OS_DD_ttee__Init_Built_Code.C" 	// 2nd Order pT   Scale Factors (Powheg/Alpgen) 
  ...
  if (isData) {
    ...
    if  ( ( channelNumber >= 107650 && channelNumber <= 107655 )  ||
	  ...
	  ( channelNumber >= 146830 && channelNumber <= 146835 )  ||
	  ( channelNumber >= 146840 && channelNumber <= 146845 )  ||
	  ( channelNumber >= 109300 && channelNumber <= 109308 )  ||
	  ( channelNumber >= 126414 && channelNumber <= 126421 )  ){
	  // Z Rate Scale Factors (mass Scale Factors for |ll.M()-91|< 8GeV)
	      #include "HforScale_FDS8GeV_3dist_OS_DD_Zee__Fill_Built_Code.C"
	      #include "HforScale_FDS8GeV_3dist_OS_DD_Zmm__Fill_Built_Code.C"
	  // Z Pt   Scale Factors (pT   Scale Factors for |ll.M()-91|< 8GeV)
	      #include "PtScale_FDS8GeV_3dist_Zdata_fitLINE_OS_CONTROL_DD_Zee__Fill_Built_Code.C"
	      #include "PtScale_FDS8GeV_3dist_Zdata_fitLINE_OS_CONTROL_DD_Zmm__Fill_Built_Code.C"
    }
    ...
    if  ( ( channelNumber >= 164440 && channelNumber <= 164443 )  ||
	  ...
	  // ttbar Rate Scale Factors (Powheg/Alpgen)
	      #include "HforScale_OS_ttDD_ee__Fill_Built_Code.C"
	      #include "HforScale_OS_ttDD_em__Fill_Built_Code.C"
	      #include "HforScale_OS_ttDD_mm__Fill_Built_Code.C"
	  // ttbar Pt   Scale Factors (Powheg/Alpgen)
	      //#include "PtScale_Powheg_ttData_AllPTtt_fitLINE_OS_DD_ttee__Fill_Built_Code.C"
	      //#include "PtScale_Powheg_ttData_AllPTtt_fitLINE_OS_DD_ttem__Fill_Built_Code.C"
	      //#include "PtScale_Powheg_ttData_AllPTtt_fitLINE_OS_DD_ttmm__Fill_Built_Code.C"

	      #include "PtScale_Powheg_ttData_AllPTtt_fit2ndLINE_OS_DD_ttee__Fill_Built_Code.C"
	      #include "PtScale_Powheg_ttData_AllPTtt_fit2ndLINE_OS_DD_ttem__Fill_Built_Code.C"
	      #include "PtScale_Powheg_ttData_AllPTtt_fit2ndLINE_OS_DD_ttmm__Fill_Built_Code.C"
    }
